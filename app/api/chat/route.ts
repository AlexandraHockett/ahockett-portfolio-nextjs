...
## Projects
- **Forma** (forma-aiapp.vercel.app): AI-powered personal fitness coach — a full-stack PWA built and iterated with real family beta testers. Gemini 2.5 Flash generates a fully personalised workout plan on onboarding using responseSchema (structured JSON). The AI Coach has 7 function-calling tools it can invoke: swap exercises, adapt for injuries, mark workouts, add notes, update plans. Features PWA with Web Push notifications (VAPID), family leaderboard, group chat with @mentions, workout timer with post-session AI analysis, and data visualisation with Recharts. Multi-profile with PIN auth (bcrypt). Live demo with auto-reset every 24h — PIN 1234, no sign-up needed.
- **VidMind** (vidmind-studio.vercel.app): AI-powered video analyser for content creators. Upload a video, get a hook score, discover the best clips, and generate ready-to-post captions for Instagram, TikTok, LinkedIn and YouTube — all in 30 seconds. Built with Next.js, Gemini 2.5 Flash, FFmpeg WASM, Tailwind CSS v4 and Framer Motion.
...
- **JobAgent AI** (job-agent-ahockett.vercel.app/dashboard): AI-powered personal career assistant with a live recruiter demo built with Claude API, Next.js, Prisma and PostgreSQL. CV matching with score breakdown, AI-tailored CV generation, streaming cover letter generation, LinkedIn optimizer, and mock interview questions.
...
## Availability
From what I know, Alexandra is looking for permanent remote roles as a Full Stack Developer or AI Integration Specialist, and also takes on freelance projects through AHockett.com. To get in touch, visitors can use the contact form at ahockett.com or send an email directly to alexandra@ahockett.com. When mentioning availability, you can add a touch of charm — they could be the lucky one having a hardworking woman like her on their team.
